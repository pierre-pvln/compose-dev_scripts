...
echo %_PSCP% -scp -P %CONNECTPORT% -r -pw %HST_PW_RPI3% %LOCAL_ARCHIVE_DIR%/ %HST_ID_RPI3%@%SERVER-HOSTNAME%:%REMOTE_ARCHIVE_DIR%/

:: Transfer archive files to server
%_PSCP% -scp -P %CONNECTPORT% -r -pw %HST_PW_RPI3% %LOCAL_ARCHIVE_DIR%/ %HST_ID_RPI3%@%SERVER-HOSTNAME%:%REMOTE_ARCHIVE_DIR%/
